...
1. Replace every {{PLACEHOLDER}} in the scaffold. Start here and follow the
   comments — the module does NOT build until they are all replaced:
     - sushi-config.yaml   (medikation, MII_IG_Medikation, MII IG Medikation,
                            FHIR profiles for representing medication data - prescriptions, administrations, statements and medication lists, including active ingredients and dosage - as part of the MII core data set., 2026.0.1, dates, …)
     - ig.ini              (the medikation in the ig path; LEAVE
     ...
     - publication-request.json, .github/workflows/go-publish.yml
       (medizininformatik-initiative, kerndatensatzmodul-medikation, canonical, …)
