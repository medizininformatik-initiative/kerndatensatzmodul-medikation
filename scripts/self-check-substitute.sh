...
#   file names (input/translations/de/ImplementationGuide-mii-ig-medikation.po
...
# ImplementationGuide-mii-ig-medikation.json; the `template =` line is left
...
# (ImplementationGuide-mii-ig-medikation.po), and the publisher matches it
