...
<a href="https://github.com/medizininformatik-initiative/kerndatensatzmodul-medikation/blob/main/docs/recipes/render-existing-artifacts.md"><code>docs/recipes/render-existing-artifacts.md</code></a> in this repository. It lists every file to remove when you delete
this page.
</div>
