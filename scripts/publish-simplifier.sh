...
# filterte status='active' und warf draft-Terminologie aus dem Paket — bei
# 2027.0.0-ballot.rc3 fehlten dadurch CodeSystem-mii-cs-pro-midos2 und beide
# MIDOS2-ValueSets, obwohl das MIDOS2-Questionnaire sie per answerValueSet
# referenziert. Seit der Template-Migration baut go-publish das maßgebliche
# package.tgz (inkl. Snapshots und vollständigem Manifest); Simplifier bekommt
# exakt dieses Artefakt, damit Registry und Publikation identisch sind.
#
# Nutzung:
