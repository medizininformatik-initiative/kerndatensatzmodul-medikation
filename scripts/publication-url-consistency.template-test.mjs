...
const canonical =
  "https://www.medizininformatik-initiative.de/fhir/modul-medikation";
const publicationBase = "https://medizininformatik-initiative.github.io/kerndatensatzmodul-medikation";
const packageId =
