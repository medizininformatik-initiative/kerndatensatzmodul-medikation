...
* rest.resource[=].supportedProfile[+] = "{profile}|2027.0.0-ballot.rc4"
...
* insert SupportSearchParam(mode, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-list-mode, #token, #SHALL)
...
* insert SupportSearchParam(dosage-site, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-site, #token, #SHALL)
* insert SupportSearchParam(dosage-route, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-route, #token, #SHALL)
...
* insert SupportSearchParam(dosage-site, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-site, #token, #SHALL)
* insert SupportSearchParam(dosage-route, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-route, #token, #SHALL)
* insert SupportSearchParam(doserange-low, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-doserange-low, #quantity, #SHALL)
* insert SupportSearchParam(doserange-high, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-doserange-high, #quantity, #SHALL)
* insert SupportSearchParam(doserange, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-doserange, #composite, #SHALL)
* insert SupportSearchParam(dose-quantity, https://www.medizininformatik-initiative.de/fhir/modul-meta/SearchParameter/mii-sp-meta-medication-dosage-dosequantity, #quantity, #SHALL)
