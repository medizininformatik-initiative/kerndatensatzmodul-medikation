...
This page documents the computable metadata of the **MII IG Medikation** module.
...
> [`input/fsh/rulesets/crmi.fsh`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-medikation/blob/main/input/fsh/rulesets/crmi.fsh) — add the corresponding rows here.]
...
`YYYY.MINOR.PATCH[-label]`, currently `2027.0.0-ballot.rc5`. The calendar year
