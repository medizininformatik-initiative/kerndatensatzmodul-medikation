...
module **MII IG Medikation** of the Medical Informatics Initiative (MII). It
...
- **[Dependencies](ImplementationGuide-mii-ig-medikation.html)** — the
...
[GitHub](https://github.com/medizininformatik-initiative/kerndatensatzmodul-medikation/issues).
