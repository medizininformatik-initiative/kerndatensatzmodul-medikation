...
UML overviews of the data models of the **MII IG Medikation** module and their relationships. Editable sources (e.g. PlantUML) belong in `input/images-source/`, the rendered images in `input/images/`.
