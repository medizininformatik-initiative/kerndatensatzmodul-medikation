...
* **[Datensätze und Beschreibungen](logical-models.html)** — die Datenelemente
  ...
  [`docs/page-structure.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-medikation/blob/main/docs/page-structure.md) in diesem Repository.)
