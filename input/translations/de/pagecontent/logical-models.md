...
Die vollständige Struktur mit Datentypen, Bindings und Invarianten steht auf der Artefaktseite [MII LM Medikation](StructureDefinition-mii-lm-medikation.html).

<!-- BEGIN GENERATED: logical-model-table -->

| Datensatz | Kard. | Erklärung |
|---|---|---|
