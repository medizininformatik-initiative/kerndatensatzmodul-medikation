...
* Stoff-Codes des deutschen Arzneimittel-Stoffkatalogs des BfArM (ASK). Es ist abzuklären, wie diese ASK-Nr. via URI/URL über BfArM/DIMDI oder ABDATA (§ 31b SGB V) öffentlich verfügbar gemacht wird. <https://www.bfarm.de/DE/Arzneimittel/Arzneimittelinformationen/Arzneimittel-recherchieren/_node.html>
...
Das CodeSystem dazu: [MII CS Medikation Wirkstofftyp](CodeSystem-mii-cs-medikation-wirkstofftyp.html).
...
Codes zur Differenzierung des Kontextes, in dem eine Medikationsliste (`List`) verwaltet wird, oder zur Kategorisierung eines Medikationseintrags (`MedicationStatement`) sind im ValueSet [MII VS Medikation Fallkontext](ValueSet-mii-vs-medikation-fallkontext.html) dargestellt.
...
| URI | Source | Comment | OID (für Nicht-FHIR-Systeme) |
|---|---|---|---|
