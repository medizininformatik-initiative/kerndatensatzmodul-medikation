...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/ValueSet/mii-vs-medikation-pzn-sales-status-code | *Version*:2027.0.0-ballot.rc5 |
| Active as of 2026-09-11 | *Computable Name*:MII_VS_Medikation_PZN_Sales_Status_Codes |
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-11T07:59:21+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
