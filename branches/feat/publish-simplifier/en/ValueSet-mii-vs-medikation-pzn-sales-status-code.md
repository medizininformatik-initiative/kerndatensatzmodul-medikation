# MII VS Medikation PZN Sales Status Codes - MII IG Medikation v2027.0.0-ballot.rc4
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/ValueSet/mii-vs-medikation-pzn-sales-status-code | *Version*:2027.0.0-ballot.rc4 |
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-09T11:59:31+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
