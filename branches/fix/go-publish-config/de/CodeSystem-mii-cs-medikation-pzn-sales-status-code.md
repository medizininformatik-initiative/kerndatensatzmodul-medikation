# MII CS Medikation PZN Sales Status Codes - MII IG Medikation v2027.0.0-ballot.rc2
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/CodeSystem/mii-cs-medikation-pzn-sales-status-code | *Version*:2027.0.0-ballot.rc2 |
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-08T15:04:14+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
