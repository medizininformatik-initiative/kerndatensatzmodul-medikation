# ValueSets - MII IG Medikation v2027.0.0-ballot.rc1
...
Diese Seite beschreibt die ValueSets des Moduls **MII IG Medikation** (Namenskonvention `MII_VS_<Modul>_<Name>`). Allgemeine Hinweise zur Verwendung von Codes: siehe [FHIR Terminology](http://hl7.org/fhir/R4/terminologies.html); die zugrunde liegenden CodeSystems beschreibt die Seite [CodeSystems](code-systems.md).
