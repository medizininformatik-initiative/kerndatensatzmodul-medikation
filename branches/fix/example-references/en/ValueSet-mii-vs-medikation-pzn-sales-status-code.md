...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/ValueSet/mii-vs-medikation-pzn-sales-status-code | *Version*:2027.0.0-ballot.rc3 |
| Active as of 2026-09-09 | *Computable Name*:MII_VS_Medikation_PZN_Sales_Status_Codes |
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-09T07:17:15+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
