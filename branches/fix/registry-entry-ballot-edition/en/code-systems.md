# Code Systems - MII IG Medikation v2027.0.0-ballot.rc5
...
* alternatively the dose form may be given as an IFA code, per the KBV medication plan specification. Key table: [https://applications.kbv.de/S_BMP_DARREICHUNGSFORM_V1.02.xhtml](https://applications.kbv.de/S_BMP_DARREICHUNGSFORM_V1.02.xhtml)
...
Codes distinguishing the context in which a medication list (`List`) is maintained, or categorising a medication statement (`MedicationStatement`), are given in the value set [MII VS Medikation Fallkontext](ValueSet-mii-vs-medikation-fallkontext.md).
