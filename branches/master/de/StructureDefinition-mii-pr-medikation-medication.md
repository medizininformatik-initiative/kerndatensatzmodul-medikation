# MII PR Medikation Medication - MII IG Medikation v2027.0.0-ballot.rc5

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Medikation Medication**

## Ressourcenprofil: MII PR Medikation Medication 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/StructureDefinition/Medication | *Version*:2027.0.0-ballot.rc5 |
| Active Stand: 2025-03-19 | *Maschinenlesbarer Name*:MII_PR_Medikation_Medication |

 
Dieses Profil beschreibt die Medikation, die angesetzt, geplant oder verabreicht wird. Es kann sich um ein Fertigarzneimittel oder eine Rezeptur handeln. Auch die Angabe nur des Wirkstoffes ist möglich. Die Angabe mindestens eines Wirkstoffes wird verlangt. 
...
Diese Struktur ist abgeleitet von [Medication](http://hl7.org/fhir/R4/medication.html) 
...
Mandatory: 1 element(19 nested mandatory elements)
...
* [https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/StructureDefinition/wirkstofftyp](StructureDefinition-mii-ex-medikation-wirkstofftyp.md)
* [https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/StructureDefinition/wirkstoffrelation](StructureDefinition-mii-ex-medikation-wirkstoffrelation.md)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-medikation-medication.csv), [Excel](../StructureDefinition-mii-pr-medikation-medication.xlsx), [Schematron](../StructureDefinition-mii-pr-medikation-medication.sch) 
