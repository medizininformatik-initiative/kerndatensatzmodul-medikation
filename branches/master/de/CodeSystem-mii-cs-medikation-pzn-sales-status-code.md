# MII CS Medikation PZN Sales Status Codes - MII IG Medikation v2027.0.0-ballot.rc3
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/core/modul-medikation/CodeSystem/mii-cs-medikation-pzn-sales-status-code | *Version*:2027.0.0-ballot.rc3 |
| Active Stand: 2026-09-08 | *Maschinenlesbarer Name*:MII_CS_Medikation_PZN_Sales_Status_Codes |
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-08T17:27:06+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
