# Guidance for Researchers - MII IG Medikation v2027.0.0-ballot.rc1
...
There is also the distinction between **precise and general ingredient**: "bisoprolol hemifumarate" and "bisoprolol" are not the same, and their quantities differ — 10 mg of the salt corresponds to 8.49 mg of the pure substance. Which level is present is stated by the [Wirkstofftyp](StructureDefinition-mii-ex-medikation-wirkstofftyp.md) extension; [Wirkstoffrelation](StructureDefinition-mii-ex-medikation-wirkstoffrelation.md) establishes the mapping between the two. Aggregating doses without accounting for this adds up unlike things.
...
Which code systems apply where is described under [Terminologies](code-systems.md); an overview of the data elements is under [Datasets and descriptions](logical-models.md).
